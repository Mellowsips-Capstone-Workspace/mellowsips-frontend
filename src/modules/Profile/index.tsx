...
const Profile = () => {
    const { id, displayName } = useAppSelector<Principle>(state => state.authenticate.principle!)
        ...
        <>
            ...
            >
                <div className='space-y-5'>
                    <p className="px-5 py-1 shadow border-b truncate font-medium">Thông tin cái nhân</p>
                    <div className='space-y-5'>
                        <div className='space-y-2'>
                            <Formik
                                ...
                                validationSchema={
                                    object().shape(
                                        {
                                            displayName: string().matches(REGEX.notBlank, "Tên hiện thị chưa hợp lệ.").required("Tên hiện thị là bắt buộc.")
                                        }
                                    )
                                }
                                onSubmit={

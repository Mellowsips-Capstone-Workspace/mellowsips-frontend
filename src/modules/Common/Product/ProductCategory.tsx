...
const ProductCategoryModal: FC<ProductCategoryModalProps> = ({ flag, closeModal, categories, setCategories, saveCategories }) => {
    ...
    return (
        ...
        >
            <p className="px-5 py-2 shadow border-b truncate font-medium">Gán nhãn cho sản phẩm</p>
                        ...
                        () => (
                            <Form>
                                <div className='flex space-x-2'>
                                    <div className='grow'>
                                        <FormikTextField.Input sm={true} name='name' placeholder='Ví dụ: Trà' />
                                    </div>
                                    <Button
                                        type="submit"
                                        variant="orange"
    ...
    return (
        <div className='space-y-1'>
            <div className='flex space-x-2 justify-between'>
                <label className='text-gray-500 font-medium'>Nhãn</label>

...
const EnterpriseBusinessInformationForm: FC = () => {
    return <>
        <h2 className="text-main-primary text-xl font-semibold py-2">Thông tin người đại diện</h2>
        <div className="space-y-5 pt-3">
            ...
            <div className="h-fit grid grid-cols-1 sm:grid-cols-2 gap-y-2 py-1">
                ...
                <FormikTextField.RadioGroup
                    name="organization.identityType"
                    direction="vertical"
                    options={
                        [
                            {
        ...
        <h2 className="text-main-primary text-xl font-semibold py-2 mt-5">Thông tin công ty</h2>
        <div className="space-y-5 pt-3">
            <div className="h-fit grid grid-cols-1 sm:grid-cols-2 gap-y-2 py-1">
                <FormikTextField.Label label="Tên công ty" required={true} />
            ...
            <div className="h-fit grid grid-cols-1 sm:grid-cols-2 gap-y-2 py-1">
                ...
                <FormikTextField.Input name="organization.businessCode" placeholder="Mã số doanh nghiệp" />
            </div>
            <div className="h-fit grid grid-cols-1 sm:grid-cols-2 gap-y-2 py-1">
                <FormikTextField.Label label="Ngày cấp Giấy chứng nhận đăng kí Doanh nghiệp" required={true} />
                <FormikTextField.DateInput
            ...
            <div className="h-fit grid grid-cols-1 sm:grid-cols-2 gap-y-2 py-1">
                <FormikTextField.Label label="Hình ảnh đầy đủ Giấy chứng nhận đăng kí Doanh nghiệp" required={true} />
                <FormikTextField.UploadFile name="organization.businessIdentityImages" multiple={true} />
            </div>
        </div>
    </>;
}

export default EnterpriseBusinessInformationForm;
...
import AddOns from 'modules/Manager/components/Product/components/AddOns'
                                ...
                                <div className='flex p-5 space-x-5 justify-between items-start'>
                                    <div className='grow space-y-5'>
                                        ...
                                        <div className='grid gap-5 grid-cols-2 items-start'>
                                            ...
                                            <div className="space-y-1">
                                                <label className='text-gray-500 font-medium'>Ràng buộc lựa chọn</label>
                                                <div className='flex space-x-2'>
                                                    <FormikTextField.Checkbox name={`${name}.${index}.isRequired`} />
                                                    {
                                                        item.isRequired ? (
                                                            <span className='bg-green-500 text-white px-1 rounded text-xs font-medium'>Bắt buộc</span>
                                                        ) : (
                                                            <span className='bg-slate-200 px-1 rounded text-xs font-medium'>Không bắt buộc</span>
                                                        )
                                                    }

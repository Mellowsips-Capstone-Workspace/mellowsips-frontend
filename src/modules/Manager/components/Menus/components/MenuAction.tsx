...
const MenuAction: FC<MenuActionProps> = ({ menu: { id, refetch, isActive, name } }) => {
    ...
    const handleRemove = useCallback(async () => {
        ...
        const { status } = await MenuService.delete(id!)
        ...
        <div className="flex space-x-2 justify-center">
            ...
            >
                <div className='space-y-5'>
                    <p className="px-5 py-2 shadow border-b truncate font-medium">Xác nhận xoá menu</p>
                    <div className='space-y-5'>
                        <p className='px-5'><span className='font-medium text-red-500'>Xác nhận xoá.</span> Menu "{name}" sẽ bị xoá.</p>
